...
public class Rent extends Listings {
  List<Date> date;

  public Rent(String name, double price, double size, int year, double ratings) {
  ...
  public void printedByBuyer(int displayNumber) {
    LogListing.forRentBuyer(displayNumber, this.name, this.price, this.size,
        this.year);
  }

  @Override
  public void printedByRealtor(int displayNumber) {
    LogListing.forRentRealtor(displayNumber, this.name, this.price, this.size,
